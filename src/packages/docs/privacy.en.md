...
Accelerometer: Device orientation detection to ensure proper interface adaptation for portrait and landscape modes

Core Functions:

- Interface adaptation: Adjust app layout based on device orientation
- Screen adaptation: Ensure content displays correctly on different screen types
- App stability: Maintain normal app operation status

Data Processing:

- Local processing: Sensor data is processed locally on device for real-time UI adjustments
- No remote transmission: Raw sensor data is never sent to remote servers
- No permanent storage: Sensor data is not permanently stored, only used temporarily during app runtime
