...
import { CancellationToken, CancellationTokenSource } from 'vscf/internal/base/common/cancellation.ts';
...
import { Disposable, IDisposable, MutableDisposable, toDisposable } from 'vscf/internal/base/common/lifecycle.ts';
